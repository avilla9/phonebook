...
export class ContactFormComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ContactFormComponent>, private _formBuilder: FormBuilder, private _contactService: ContactsService) { }
  ...
  onContactPrefernceChange(selectedValue: string) {
    ...
    if (selectedValue === 'mobile') {
      ...
      phoneFormControl.setValidators([Validators.required, Validators.pattern(this.mobilePattern), Validators.maxLength(20), Validators.minLength(10)]);
